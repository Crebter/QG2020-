...
<div id="main" class="wrap">
	...
	<div class="main">
			<h2>处理投诉信息</h2>
		<div class="manage">
			<form action="ComplainServlet?method=doComplainUpdate" method="post">
				<table class="form">
					<tr>
						<td class="field">投诉单：</td>
						<td><input type="text" class="text" name="id"  value="${sessionScope.updateComplain.getId() }"  readonly/></td>
					</tr>
					<tr>
						<td class="field">投诉人：</td>
						<td><input type="text" class="text" name="nickname"  value="${sessionScope.updateComplain.getNickname() }" readonly/></td>
					</tr>
					<tr>
						<td class="field">投诉内容：</td>
						<td><textarea name="content" readonly="readonly">${sessionScope.updateComplain.getContent() }</textarea></td>
					</tr>	
					<tr>
						<td class="field">投诉时间：</td>
						<td><input type="text" class="text" name="contenttime"  value="${sessionScope.updateComplain.getContenttime() }" readonly/></td>
					</tr>	
					...
					<tr>
						<td></td>
						<td><label class="ui-blue"><input type="submit" name="submit" value="完成" /></label></td>
					</tr>
				</table>
			</form>
		</div>
