		...
		<div class="guestbook">
			...
			<ul>
				<li>
					...
					<dl>
						<dt>投诉内容:${com.getContent() }</dt>
						<dd class="author">投诉人:${com.getNickname() }
						<span class="timer">投诉时间:  ${com.getContenttime() }</span></dd>
						<dd><c:choose>
							   <c:when test="${com.getReply() == null}"> 
							         	未回复      
							   </c:when>
							   <c:otherwise>
							    	管理员回复:${com.getReply() }
			...
			<div id="reply-box">
				<form action="ComplainServlet?method=insert" method="post">		
					<table>	
						<tr>
							<td class="field">昵称：</td>
							<td><input class="text" name="nickname" /></td>
						</tr>
						<tr>
							<td class="field">投诉内容：</td>
							<td>
							<textarea id="content_1" name="content" ></textarea>
							</td>
						</tr>
						<tr>
							<td></td>
							<td><label class="ui-blue"><input type="submit" name="submit" value="提交投诉信息" /></label></td>
						</tr>
					</table>
				</form>
			</div>
