...
<div id="main" class="wrap">
	...
	<div class="main">
		...
		<div class="hot">
			<h2 style="font-size:20px;" align="center" >热卖推荐</h2>
			<ul class="product clearfix">
				<c:forEach var="hotp" items="${hlist}">
					<li>
						<dl>
							<dt><a href="selectProductView?id=${hotp.EP_ID }" target="_blank"><img src="D:/upload/${hotp.EP_FILE_NAME }" /></a></dt>
							<dd class="title"><a href="selectProductView?id=${hotp.EP_ID }" target="_blank">${hotp.getIntroduction()}</a></dd>
							<dd class="price">${hotp.getPrice() }.00</dd>
						</dl>
					</li>
				</c:forEach>
			</ul>
